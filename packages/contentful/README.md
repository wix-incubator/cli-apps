## <div style=" display: flex; align-items: center;"><img src="docs/contentful-wix.png" alt="contentful-wix.png" width="100"/><span>Contentful Integration with Wix</span></div>
...
2. Install the application and establish the connection between your Contentful account and Wix site:   
   ...
   ![contentful-on-wix-config.png](docs%2Fcontentful-on-wix-config.png)
...
3. Navigate to the CMS tab in your business manager. Under "External Collections," you will find a new namespace named "contentful-on-wix," housing all your content models and data.
   ![cms-external-connections.png](docs%2Fcms-external-connections.png)
...
2. Add dataset to your page
   ...
   ![add-data-set.png](docs%2Fadd-data-set.png)
...
![add-dynamic-page.png](docs%2Fadd-dynamic-page.png)
